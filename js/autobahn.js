...
ab.Session = function (wsuri, onopen, onclose, options) {
   ...
   //alert(options.unsolicited_cb);
   if ("unsolicited_cb" in options) {
      self._unsolicited_cb = options.unsolicited_cb;
   } else {
      self._unsolicited_cb = null;
   }
...
//alert(o);
      ...
      else if (o[0] === ab._MESSAGE_TYPEID_EVENT)
      {
         ...
         if (subid in self._subscriptions) {
            ...
            // Do not ignore unsolicited event!
         }
      }
      else if (o[0] === ab._MESSAGE_TYPEID_WELCOME)
      {
         if (self._session_id === null) {
            ...
            if (typeof self._unsolicited_cb === 'function') {
               self._unsolicited_cb(o[1]);
            }
      }
   };
